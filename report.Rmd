...
(@) For the technically inclined, the code for this algorithm can be viewed below:
...
(@) In the data below, we can see that for *Person 1*, they strictly prefer *Session 2* over *Session 1*, $u_{d_1}(2) > u_{d_1}(1)$.
