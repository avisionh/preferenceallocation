...
# Load data
utility_students <- read_csv(file = "data/dummy_student_preferences.csv")
...
[^1]: This was the introductory lecture your author received when starting his first year of BSc. Mathematics and Economics course at the London School of Economics and Political Science (LSE). [Sveriges Riksbank prize in Economic Sciences in Memory of Alfred Nobel 2012](https://www.nobelprize.org/nobel_prizes/economic-sciences/laureates/2012/popular-economicsciences2012.pdf)
...
### How it Works
(@) The **Gale-Shapley algorithm** involves a number of rounds/iterations: [^2]
